...
<head>
    ...
    <style>
        ...
        .four_zero_four_bg {
            background-image: url(<?php echo e(asset('login/images/dribbble_1.gif')); ?>);
            height: 400px;
                        ...
                        <div class="col-md-12">
                            <div class="col-sm-10 col-sm-offset-1  text-center">
                                ...
                                <div class="contant_box_404 text-center">
                                    <h5 class="h2">Hello! <span><?php echo e(@session()->get('socialuser')->name); ?></span> look like you're not registered with Alumni management system</h5>
                                    <a href="#" class="link_404">Register</a>
                                    <a href="<?php echo e(route('login')); ?>" class="link_back">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\aams\resources\views/custom.blade.php ENDPATH**/ ?>